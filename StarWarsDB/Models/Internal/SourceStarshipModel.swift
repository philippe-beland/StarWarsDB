...
@Observable
class SourceStarshipModel: SourceEntity {
    ...
    init(source: Source, entity: StarshipModel, appearance: AppearanceType, number: Int = 0) {
        let id = UUID()
        
        super.init(id: id, source: source, entity: entity, appearance: appearance, number: number, recordType: "SourceStarshipModels", databaseTableName: "source_starship_models")
    }
